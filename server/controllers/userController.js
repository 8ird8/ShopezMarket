  ...
  try {
    ...
    if (!checkEmail) {
      if (req.body.password === req.body.confirmPassword) {
        ...
        const link = `https://shopez-market.vercel.app/users/${newUser._id}/verify/${VerifyToken.token}`;
        const htmltemplate = `
        <div style="
            width: 100%;
            height: 100%;
    ...
    if (data) {
      ...
      if (passwordMatch) {
        ...
        if (!data.isVerified) {
          ...
          const link = `https://shopez-market.vercel.app/users/${data._id}/verify/${checkToken.token}`;
          const htmltemplate = `
              <div style="
                  width: 100%;
                  height: 100%;
